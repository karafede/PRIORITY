...
This work presents the design and the implementation of a digital platform for <strong>  urban mobility </strong>  as instrument addressed to decision makers. The platform allows aggregating mobilit mobility data  within   <strong> traffic zones  </strong> for analysis of  <strong> travel demand, polluting emissions, energy consumption and externalities  </strong> in the metropolitan city of Rome (Italy). The platform has been designed to retrieve mobility insights from 
